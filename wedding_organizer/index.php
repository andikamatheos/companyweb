<?php
	...
	$pages = array(
		...
		'1'	=> array('id' => '2', 'alias' => 'Tentang-kami', 'file' => '2.php','controllers' => array()),
		'2'	=> array('id' => '5', 'alias' => 'Produk', 'file' => '5.php','controllers' => array()),
		'3'	=> array('id' => '3', 'alias' => 'Kontak', 'file' => '3.php','controllers' => array())
	);
	$forms = array(
		'3'	=> array(
			'd5a5aa66' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Enquire from the web page', 'sentMessage' => unserialize('s:22:"Formulir telah dikirim";'), 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'maxFileSizeTotal' => '2', 'fields' => array( array( 'fidx' => '0', 'name' => 'Nama', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '2', 'name' => 'Pesan', 'type' => 'textarea', 'required' => 1, 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	$base_lang = 'id';
	$site_id = "321aebf4";
	$websiteUID = "fc98a2c21a2f01eab203c766a54e37c74e8c0c471a9583ef7ca74ab2fa515d52dbdee86e40086483";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'nurjirehwedding.net';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "http://uk.zyro.com/id-ID/comment_callback/";
	$user_key = "s8Navw0esel8SdWHVTVBJLSwWw==";
	$user_hash = "e38840b44971095c";
